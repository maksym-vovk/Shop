...
const SearchInputButton = (props) => {
  return (
    <button onClick={ () => { if (props.input.trim()) { props.onClick(); props.history.push(`/search_result/${props.input}`) } }} className="search-btn">
      <svg
...
export default withRouter(SearchInputButton)