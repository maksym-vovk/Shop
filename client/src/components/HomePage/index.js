    ...
    <div className="wrap-for-img container">
      ...
      <div className="content-watch">
        ...
        <div className="text-wrap">
          ...
          <p className="text-wrap__content">
            Get connected through sport. Apple Watch Nike is the perfect running
            partner with the Nike Run Club app. Featuring a world of workouts,
            coaching, and motivation to help take your fitness to the next
            level. And with Apple Watch Series 5, every Nike watch face is
            optimized for the new Always-On Retina display.
          </p>
      ...
      <div className="content-watch">
        ...
        <div className="text-wrap">
          ...
          <p className="text-wrap__content">
            A deep collaboration. A dramatic new collection. A partnership based
            on parallel thinking and shared values continues. Now with a wide
            range of new and current Hermès cases and bands, new faces designed
            for the Always-On Retina display, and a special combination in all
            black. Apple Watch Hermès is the ultimate tool for modern life —
            with more than a dash of sophistication.
          </p>
      ...
      <div className="content-watch">
        ...
        <div className="text-wrap">
          ...
          <p className="text-wrap__content">
            ...
            titanium and ceramic. Featuring all the innovations of Series 5 and
            the craftsmanship of traditional watchmaking. It’s as modern as can
            be and as classic as it gets.
          </p>
